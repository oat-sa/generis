...
class FileSystemComponentTest extends TestCase
{
    ...
    public function testCheckDirectoryPermissionsSuccess()
    {
        ...
        $this->assertEquals(
            "File system component 'tao.configuration.filesystem' in 'vfs://testDir7 is compliant with "
                . "expected rights (rw).'",
            $output->getMessage()
        );
    }
    ...
    public function testCheckFilePermissionsSuccess()
    {
        ...
        $this->assertEquals(common_configuration_Report::VALID, $output->getStatus());
        $this->assertEquals(
            "File system component 'tao.configuration.filesystem' in 'vfs://testDir8/test.txt is compliant "
                . "with expected rights (rwx).'",
            $output->getMessage()
        );
    }
    ...
    public function testCheckDirectoryContentSuccess()
    {
        ...
        $this->assertEquals(common_configuration_Report::VALID, $output->getStatus());
        $this->assertEquals(
            "File system component 'tao.configuration.filesystem' in 'vfs://testDir10 is compliant with "
                . "expected rights (rw).'",
            $output->getMessage()
        );
    }
