...
HTMLArea.Config = function () {
	...
	this.toolbar = [
		[ 
		  "bold", "italic", "space", "space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","space","insertunorderedlist", "outdent", "indent", "forecolor",  "createlink", "insertimage", "copy", "cut", "paste", "undo", "redo","htmlmode", 
		  "showhelp", "about","textbox"
	...
	this.btnList = {
		bold: [ "Bold", "Unit.gif", false, function(e) {e.execCommand("bold");} ],
		italic: [ "Italic", "Value.gif", false, function(e) {e.execCommand("italic");} ],
...
HTMLArea.prototype.generate = function () {
	...
	textarea.style.width = iframe.style.width;
 	...
 	htmlarea.style.width = iframe.style.width;
