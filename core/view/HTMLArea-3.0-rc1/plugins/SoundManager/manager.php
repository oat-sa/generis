 ...
 */
	...
	$defaultLogo = '';
	if(file_exists($IMConfig['base_dir'].'sound/sound.jpeg')){
		$defaultLogo = $IMConfig['base_url'].'sound/sound.jpeg';
	}
...
<head>
	...
	<link href="assets/manager.css" rel="stylesheet" type="text/css" />	
 	...
 	<script type="text/javascript" src="/filemanager/views/js/jquery-1.4.2.min.js"></script>
	<script type="text/javascript" src="/filemanager/views/js/fmRunner.js"></script>
	<script type="text/javascript" src="/filemanager/views/js/jquery.fmRunner.js"></script>
...
<fieldset><legend>Sound Manager</legend>
<div class="dirs">
...
<!-- image properties -->
	<table class="inputTable">
		<tr>
			<td align="right"><label for="f_url">Sound File</label></td>
			<td><input type="text" id="f_url" class="largelWidth" value="" /></td>
			<td rowspan="3" align="right">&nbsp;</td>
			<td align="right"><label for="f_width">Delay</label></td>
			<td><input type="text" id="f_width" class="smallWidth" value="0"/></td>
			
			<td rowspan="3" align="right">&nbsp;</td>
			<td align="right"><label for="f_vert">nblisten</label></td>
			<td><input type="text" id="f_vert" class="smallWidth" value="" /></td>
		</tr>		
		<tr>
			<td align="right"><label for="f_alt">Logo</label></td>
			<td><input type="text" id="f_alt" class="largelWidth" value="<?=$defaultLogo?>" /></td>
			<td align="right"><label for="f_height"></label></td>
			<td><input type="hidden" id="f_height" class="smallWidth" value="" onchange="javascript:checkConstrains('height');"/></td>
			<td align="right"><label for="f_horiz"></label></td>
...
<? } else { ?>
			<td colspan="2"></td>
<? } ?>
			<td align="right"><label for="f_align">visible</label></td>
			<td colspan="2">
			...
			<td align="right"><label for="f_border"></label></td>
			<td><input type="hidden" id="f_border" class="smallWidth" value="" /></td>
		</tr>
		<tr> 
         <td colspan="4" align="right">
				<input type="hidden" id="orginal_width" />
				<input type="hidden" id="orginal_height" />
            <input type="hidden" id="constrain_prop" checked="checked" onclick="javascript:toggleConstrains(this);" />
          </td>
          <td colspan="5"><label for="constrain_prop"></label></td>
      </tr>
	</table>
<!--// image properties -->	
