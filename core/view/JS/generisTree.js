 ...
 */
YAHOO.widget.generisNode = function(oData, oParent, expanded, checked) {
...
YAHOO.extend(YAHOO.widget.generisNode, YAHOO.widget.TextNode, {

    /**
     *  True if we use checkbox to select class
     *
     */
    checkNodeEnable: false,
    ...
    generisNodeParentChange: function() {
        //this.updateParent();
    },
    ...
    setUpCheck: function(checked) {
        ...
        this.subscribe("parentChange", this.generisNodeParentChange);

    },

    /**
     * The id of the check element
     * @for YAHOO.widget.generisNode
     * @type string
     */
    ...
    getNodeHtml: function() { 
        ...
        // check box
        if((this.labelStyle == "icon-instance") && (this.checkNodeEnable)) {
	        sb[sb.length] = '<td';
    ...
    toString: function() {
        return "generisNode (" + this.index + ") " + this.label;
    }
