...
var TREE_TPL = {
	'target'  : 'pane',	// name of the frame links will be opened in
	...
	'icon_16' : 'icons/Class.gif', // node icon normal
	'icon_20' : 'icons/Class.gif', // node icon selected
	'icon_24' : 'icons/Class.gif', // node icon opened
	'icon_28' : 'icons/Class.gif', // node icon selected opened

	'icon_0'  : 'icons/Class.gif', // leaf icon normal
