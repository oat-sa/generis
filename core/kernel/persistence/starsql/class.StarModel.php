...
class core_kernel_persistence_starsql_StarModel extends ConfigurableService implements Ontology, Cacheable
{
    ...
    public function getPersistence(): common_persistence_GraphPersistence
    {
    ...
    {
        return new core_kernel_persistence_starsql_StarRdf($this);
    }
    ...
    {
        return new core_kernel_persistence_starsql_StarRdfs($this);
    }
