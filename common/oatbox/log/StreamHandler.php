...
class StreamHandler extends MonologStreamHandler
{
     ...
     * @param int $defaultLevel (Unless this parameter is specified on the command line as --log-level, otherwise it
     *                          is ignored) The minimum logging level at which this handler will be triggered
