 ...
 * Class PdoStore
 *
 * NOTE: extend if from Symfony\Component\Lock\Store\PdoStore and deprecate after moving tao to php7 version.
 *
...
class PdoStore implements StoreInterface
{
    ...
    public function __construct($connOrDsn, array $options = [], $gcProbability = 0.01, $initialTtl = 300)
    {
        ...
        $this->tokenCol = isset($options['db_token_col']) ? $options['db_token_col'] : $this->tokenCol;
        $this->expirationCol = isset($options['db_expiration_col']) ? $options['db_expiration_col']: $this->expirationCol;
     ...
     */
    private function getHashedKey(Key $key)
    {
        return hash('sha256', (string) $key);
    }
    private function getUniqueToken(Key $key)
    {
     ...
     */
    private function getCurrentTimestampStatement()
    {
