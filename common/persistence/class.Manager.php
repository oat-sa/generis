...
class common_persistence_Manager
{
    ...
    private static $driverMap = array(
        'pdo_mysql'  => 'common_persistence_SqlDriver',
        'pdo_sqlite' => 'common_persistence_SqlDriver',
        'pdo_pgsql'  => 'common_persistence_SqlDriver',
        'pdo_oci'    => 'common_persistence_SqlDriver',
