...
define('GENERIS_VERSIONED_REPOSITORY_LOGIN' , 'tao');
define('GENERIS_VERSIONED_REPOSITORY_PASSWORD' , 'tao');
define('GENERIS_VERSIONED_REPOSITORY_TYPE' , 'svn');
define('GENERIS_VERSIONED_REPOSITORY_URL' , 'http://tao.localhost/taoVersionning/');
