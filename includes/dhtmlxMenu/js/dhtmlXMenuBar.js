 ...
 if((that.parentPanel.topMenu.ieWinMode)&&(!that.parentPanel.parentPanel))
{
 ...
 var localisation = document.location;
 

isPlugin = getURLParam('do');
 launchedplugin = getURLParam('param1');
 var patternstr= 'index.php?do='+isPlugin+'&param1='+launchedplugin;
 var positionOfIndex = document.location.href.indexOf('index');
 var newUrl = document.location.href.substring(0,positionOfIndex) + 'index.php?do=plugin&param1='+this.id;
