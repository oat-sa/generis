...
define('_RDF_SUBJECT_TYPE_URI',0);
define('_RDF_SUBJECT_TYPE_DISTRIBUTED',1);
define('_RDF_SUBJECT_TYPE_PREFIX',2);
define('_RDF_SUBJECT_TYPE_ANONYMOUS',3);
define('_RDF_SUBJECT_TYPE_BNODE',4);
define('_RDF_OBJECT_TYPE_RESOURCE',0);
define('_RDF_OBJECT_TYPE_LITERAL',1);
define('_RDF_OBJECT_TYPE_XML',2);
define('_RDF_OBJECT_TYPE_BNODE',3);
...
define('_RDF_NAMESPACE_URI','http://www.w3.org/1999/02/22-rdf-syntax-ns#' );
define('_RDF_NAMESPACE_PREFIX','rdf' );
define('_RDF_RDF','RDF');
define('_RDF_DESCRIPTION','Description');
define('_RDF_ID','ID');
define('_RDF_ABOUT','about');
define('_RDF_ABOUT_EACH','aboutEach');
define('_RDF_ABOUT_EACH_PREFIX','aboutEachPrefix');
define('_RDF_BAG_ID','bagID');
define('_RDF_RESOURCE','resource');
define('_RDF_VALUE','value');
define('_RDF_PARSE_TYPE','parseType');
define('_RDF_PARSE_TYPE_LITERAL','Literal');
define('_RDF_PARSE_TYPE_RESOURCE','Resource');
define('_RDF_PARSE_TYPE_COLLECTION', 'Collection');
define('_RDF_TYPE','type');
define('_RDF_BAG','Bag');
define('_RDF_SEQ','Seq');
define('_RDF_ALT','Alt');
define('_RDF_LI','li');
define('_RDF_STATEMENT','Statement');
define('_RDF_SUBJECT','subject');
define('_RDF_PREDICATE','predicate');
define('_RDF_OBJECT','object');
define('_RDF_NODEID','nodeID');
define('_RDF_DATATYPE','datatype');
define('_RDF_SEEALSO','seeAlso');
define('_RDF_PROPERTY','Property');
define('_RDF_LIST','List');
define('_RDF_NIL','nil');
define('_RDF_REST','rest');
define('_RDF_FIRST','first');
define('_RDF_XMLLITERAL', 'XMLLiteral');

// ----------------------------------------------------------------------------------
// RDF Schema
// ----------------------------------------------------------------------------------

define('_RDF_SCHEMA_URI','http://www.w3.org/2000/01/rdf-schema#' );
define('_RDF_DATATYPE_SCHEMA_URI','http://www.w3.org/TR/xmlschema-2' );
define('_RDF_SCHEMA_PREFIX', 'rdfs');
define('_RDFS_SUBCLASSOF','subClassOf');
define('_RDFS_SUBPROPERTYOF','subPropertyOf');
define('_RDFS_RANGE','range');
define('_RDFS_DOMAIN','domain');
define('_RDFS_CLASS','Class');
define('_RDFS_RESOURCE','Resource');
define('_RDFS_DATATYPE','Datatype');
define('_RDFS_LITERAL','Literal');
define('_RDFS_SEE_ALSO','seeAlso');
define('_RDFS_IS_DEFINED_BY','isDefinedBy');
define('_RDFS_LABEL','label');
define('_RDFS_COMMENT','comment');
...
$short_datatype = array(
    'STRING'    => _RDF_DATATYPE_SCHEMA_URI . '#string',
    'DECIMAL'   => _RDF_DATATYPE_SCHEMA_URI . '#decimal',
    'INTEGER'   => _RDF_DATATYPE_SCHEMA_URI . '#integer',
    'INT'       => _RDF_DATATYPE_SCHEMA_URI . '#int',
    'SHORT'     => _RDF_DATATYPE_SCHEMA_URI . '#short',
    'BYTE'      => _RDF_DATATYPE_SCHEMA_URI . '#byte',
    'LONG'      => _RDF_DATATYPE_SCHEMA_URI . '#long',
    'LANGUAGE'  => _RDF_DATATYPE_SCHEMA_URI . '#language',
    'NAME'      => _RDF_DATATYPE_SCHEMA_URI . '#name'
);

// ----------------------------------------------------------------------------------
// Database 
// mapped with TAO AdoDb conf
...
$default_prefixes = array(
   _RDF_NAMESPACE_PREFIX => _RDF_NAMESPACE_URI,
   _RDF_SCHEMA_PREFIX => _RDF_SCHEMA_URI,
