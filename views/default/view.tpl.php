...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		<h1>Generis Extensions Manager</h1>
		<div id="message">
			...
			<table summary="modules" class="maximal">
				...
				<?php foreach($availlableExtArray as $k=>$ext): ?>
					<tr>
						...
						<th>			
							<input name="id" value="<?php echo urlencode($k) ;?>" type="hidden" /> 
							<input name="package_zip" value="<?php echo urlencode($ext['zip']) ;?>" type="hidden" /> 
				...
				<table summary="modules" class="maximal">
					...
					<thead>
						<tr>
							...
							<th class="nowrap"><?php echo __('Lastest Version'); ?></th>
							<th><?php echo __('Author'); ?></th>
							<th><?php echo __('Required Extensions'); ?></th>
					...
					<?php foreach($installedExtArray as $extensionObj): ?>
						...
						<tr>
							...
							<th>
							<ul>
							<?php foreach ($extensionObj->requiredExtensionsList as $req):?>
								<li><?php echo $req ; ?></li>
								<?php endforeach;?>
							</ul>
							</th>	
